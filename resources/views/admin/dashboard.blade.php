...
<div class="row">
        <div class="col-md-12 grid-margin">
         @if(session('message'))
          ...
          @endif
             <div class="md-md-3 md-x1-5">
                    <h2>Dashboard,</h2>
                    <p class="md-md-0">Your analytics dashboard template.</p>
                    <hr>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                    <div class="card card-body bg-warning text-white mb-3"> <label>Total Brands</label>
                        <h1>{{ $totalBrands }}</h1>
